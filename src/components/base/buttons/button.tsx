...
export const styles = sortCx({
    ...
    sizes: {
        xs: {
            root: [
                "h-11 gap-1 rounded-lg px-2.5 py-1.5 text-sm font-semibold before:rounded-[7px] data-icon-only:size-11 data-icon-only:p-0",
        ...
        sm: {
            root: [
                "h-11 gap-1 rounded-lg px-3 py-2 text-sm font-semibold before:rounded-[7px] data-icon-only:size-11 data-icon-only:p-0",
                "in-data-input-wrapper:px-3.5 in-data-input-wrapper:py-2.5 in-data-input-wrapper:data-icon-only:p-2.5",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-3",
        },
    ...
    colors: {
        ...
        "link-color": {
            root: [
                "h-auto! justify-normal rounded p-0! text-brand-secondary hover:text-brand-secondary_hover",
        ...
        "link-gray": {
            root: [
                "h-auto! justify-normal rounded p-0! text-tertiary hover:text-tertiary_hover",
                // Inner text underline
        ...
        "link-destructive": {
            root: [
                "h-auto! justify-normal rounded p-0! text-error-primary outline-error hover:text-error-primary_hover",
                // Inner text underline
